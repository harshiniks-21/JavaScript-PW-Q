...
//x()-> x acts as function name
// x variable is called as function expression
...
//! ex:
 ...
 display()  //display acts as Function Name
 //display variable is a function expression
 //! 3> Function Expression :

 //! storing a function inside a variable
 //named 
 //anonymous
  //? named function is a function Expression

  let f1=function demo()
  {
  ...
  //! nested Function :
  //? A function which is declared inside another function
  //! syntax:
...
function outer() //2
{
    ...
    let y="Hello"
    function inner(){ //6
        console.log("Hello EveryOne") //7
        let x="HI"
        console.log(x) //8 -->
    }
    console.log(x) //3-->10
    console.log(y)//4-->'hello
    inner() //5
}
outer() //1
